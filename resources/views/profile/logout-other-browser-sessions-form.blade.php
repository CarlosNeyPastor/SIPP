<x-jet-action-section>
  ...
  <x-slot name="description">
    {{ __('Administrar y cerrar sesión de sus sesiones activas en otros navegadores') }}
  </x-slot>
  ...
  <x-slot name="content">
            ...
            <div class="ms-2">
              ...
              <div>
                <div class="small text-muted">
                  ...
                  @else
                    {{ __('Conexión: ') }} {{ $session->last_active }}
                  @endif
                </div>
              </div>
            </div>
    ...
    <div class="d-flex mt-3">
      <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
        {{ __('Cerrar sesión en otros dispisitivos') }}
      </x-jet-button>
    </div>
    ...
    <x-jet-dialog-modal wire:model="confirmingLogout">
      ...
      <x-slot name="content">
        {{ __('Inghrese la contraseña para confirmar la accion') }}
