<x-jet-form-section submit="updateProfileInformation">
  <x-slot name="title">
    {{ __('Información de la cuenta del perfil') }}
  </x-slot>
  ...
  <x-slot name="form">
    ...
    <!-- Name -->
    <div class="mb-3">
      <x-jet-label class="form-label" for="name" value="{{ __('Nombre completo') }}" />
      <x-jet-input readonly id="name" type="text" class="{{ $errors->has('name') ? 'is-invalid' : '' }}"
