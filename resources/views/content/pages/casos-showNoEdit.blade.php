  ...
  <div class="row">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{route('EventController.solicitar_archivar')}}" autocomplete="off">
          ...
          <?php if ($event->estadoCaso == 0): ?>
            <button type="submit" name="button" value="solicitar" class="btn btn-primary">Solicitar</button>
